            ...
            <section class="pb-5">
                <div class="container px-4 px-lg-5 mb-5 p-5">
                    <div class="row gx-4 gx-lg-5">
                        <div class="col-md-3 text-fog text-center d-inline-block">
                            <ul class="nav nav-pills">
                                ...
                                <li>
                                    <a class="text-decoration-none text-center text-fog h5" href="${pageContext.request.contextPath}/carport/flat-roof">Carport med rejsning</a>
                                    <hr class="w-100">
                                </li>
                                <li>
                        ...
                        <div class="col-md-9">
                            <form action="${pageContext.request.contextPath}/addToCart" method="POST">
                                <h2 class="fw-bolder">Quick byg en carport</h2>
                                <hr>
